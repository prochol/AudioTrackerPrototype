...
OSStatus LBAudioDetectiveCompareAudioURLs(LBAudioDetectiveRef inDetective, NSURL* inFileURL1, NSURL* inFileURL2, UInt32 inComparisonRange, Float32* outMatch) {
    ...
    LBErrorCheck(error);
    NSLog(@"Completed fingerprint for URL: %@", inFileURL1.absoluteString);
    NSLog(@"Subfingerprint Length: %i", inDetective->subfingerprintLength);
    ...
    LBErrorCheck(error);
    NSLog(@"Completed fingerprint for URL: %@", inFileURL2.absoluteString);
    NSLog(@"Subfingerprint Length: %i", inDetective->subfingerprintLength);
